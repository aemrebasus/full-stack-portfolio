...
ConfirmComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ConfirmComponent, selectors: [["app-confirm"]], inputs: { meta: "meta" }, outputs: { response: "response" }, decls: 16, vars: 16, consts: [["tabindex", "-1", "role", "dialog", "aria-labelledby", "id", "aria-hidden", "true", 1, "modal", "fade", 3, "id"], ["role", "document", 1, "modal-dialog"], [1, "modal-content"], [1, "modal-title"], ["type", "button", "data-dismiss", "modal", 1, "btn"], [1, "modal-body"], [1, "container-fluid"], [1, "modal-footer"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-secondary", 3, "click"], ["type", "button", "data-dismiss", "modal", 3, "click"]], template: function ConfirmComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ConfirmComponent_Template_button_click_12_listener() { return ctx.cancel(); });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfirmationMetas", function() { return ConfirmationMetas; });
/**
 * Confirmation modal for each operation;
 */
class ConfirmationMetas {
    static all() {
        return [
    ...
    static edit() {
        const editConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'edit', type: 'edit', title: 'Confirmation of Updating', message: 'Would you like to edit the item?' });
        return editConfirmation;
    }
    static update() {
        const editConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'update', type: 'update', title: 'Confirmation of Updating', message: 'Would you like to update the item?' });
        return editConfirmation;
    }
    static save() {
        const saveConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'save', type: 'save', title: 'Confirmation of Saving', message: 'Would you like to save the item?' });
        return saveConfirmation;
    }
    static close() {
        const closeConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'close', type: 'close', title: 'Closing Dialog', message: 'You will lose the form data!' });
        return closeConfirmation;
    }
    static back() {
        const closeConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'back', type: 'back', title: 'Closing Dialog', message: 'You will lose the form data!' });
        return closeConfirmation;
    }
    static reset() {
        const closeConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'reset', type: 'reset', title: 'Reseting Form', message: 'Would you like to reset the form?' });
        return closeConfirmation;
    }
    static open() {
        const closeConfirmation = Object.assign(Object.assign({}, ConfirmationMetas.delete()), { id: 'open', type: 'open', title: 'Openning', message: 'Would you like to open it?' });
        return closeConfirmation;
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TconfirmationModule", function() { return TconfirmationModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confirm/confirm.component */ "./src/pma-app/shared/tconfirmation/confirm/confirm.component.ts");




class TconfirmationModule {
}
TconfirmationModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: TconfirmationModule });
TconfirmationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function TconfirmationModule_Factory(t) { return new (t || TconfirmationModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TconfirmationModule, { declarations: [_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]], exports: [_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TconfirmationModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                declarations: [
                    _confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmComponent"]
                ],
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]
                ],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _shared_tconfirmation_confirm_confirm_interfaces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @shared/tconfirmation/confirm/confirm.interfaces */ "./src/pma-app/shared/tconfirmation/confirm/confirm.interfaces.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _tconfirmation_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../tconfirmation/confirm/confirm.component */ "./src/pma-app/shared/tconfirmation/confirm/confirm.component.ts");





function ModalWrapperComponent_app_confirm_11_Template(rf, ctx) { if (rf & 1) {
    const _r75 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-confirm", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("response", function ModalWrapperComponent_app_confirm_11_Template_app_confirm_response_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r75); const ctx_r74 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r74.confirm($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const cm_r73 = ctx.$implicit;
...
ModalWrapperComponent.ɵfac = function ModalWrapperComponent_Factory(t) { return new (t || ModalWrapperComponent)(); };
ModalWrapperComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ModalWrapperComponent, selectors: [["app-modal-wrapper"]], inputs: { bgColor: "bgColor", textColor: "textColor", title: "title" }, outputs: { confirmEvent: "confirmEvent" }, ngContentSelectors: _c0, decls: 14, vars: 11, consts: [[1, "modal-wrapper", "pt-5"], [1, "row", "col-md-12", "pt-5"], [1, "col-md-4"], [1, "col-md-4", "pt-5"], [1, "card"], ["type", "button", "data-toggle", "modal", "data-target", "#close", 1, "btn"], [1, "card-body"], [3, "meta", "response", 4, "ngFor", "ngForOf"], [3, "meta", "response"]], template: function ModalWrapperComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TmodalModule", function() { return TmodalModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _modal_wrapper_modal_wrapper_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modal-wrapper/modal-wrapper.component */ "./src/pma-app/shared/tmodal/modal-wrapper/modal-wrapper.component.ts");
/* harmony import */ var _shared_tconfirmation_tconfirmation_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @shared/tconfirmation/tconfirmation.module */ "./src/pma-app/shared/tconfirmation/tconfirmation.module.ts");
...
TmodalModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: TmodalModule });
TmodalModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function TmodalModule_Factory(t) { return new (t || TmodalModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _shared_tconfirmation_tconfirmation_module__WEBPACK_IMPORTED_MODULE_3__["TconfirmationModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TmodalModule, { declarations: [_modal_wrapper_modal_wrapper_component__WEBPACK_IMPORTED_MODULE_2__["ModalWrapperComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _shared_tconfirmation_tconfirmation_module__WEBPACK_IMPORTED_MODULE_3__["TconfirmationModule"]], exports: [_modal_wrapper_modal_wrapper_component__WEBPACK_IMPORTED_MODULE_2__["ModalWrapperComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TmodalModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                ...
                exports: [
                    _modal_wrapper_modal_wrapper_component__WEBPACK_IMPORTED_MODULE_2__["ModalWrapperComponent"]
                ]
            }]
    }], null, null); })();
...
//# sourceMappingURL=default~shared-tdialog-tdialog-module~shared-tform-tform-module-es2015.js.map